...
test('should render one movie title and poster', () => {
  ...
  expect(component).toContainReact(
    <img src={'/posters/harry-potter-and-the-chamber-of-secrets'} alt={'Harry Potter and Chamber of Secrets'} />
  )
})

test('should render multiples movies title and poster', () => {
  // Given
  const movies: IMovie[] = [harryPotterAndThePhilosophersStoneMovie, harryPotterAndTheChamberOfSecretsMovie]
  // When
  const component = shallow(<App categories={[]} movies={movies} />)
  ...
  expect(component).toContainReact(<h3 className='mb-5'>Harry Potter and Chamber of Secrets</h3>)
  expect(component).toContainReact(
    <img src={'/posters/harry-potter-and-the-philosopher-s-stone'} alt={"Harry Potter and the Philosopher's Stone"} />
  )
  expect(component).toContainReact(
    <img src={'/posters/harry-potter-and-the-chamber-of-secrets'} alt={'Harry Potter and Chamber of Secrets'} />
  )
