      ...
      <header class='py-10'>
        <div class='container mx-auto'>
          <div class='sm:flex items-center justify-between'>
            <a href='/' class='logo lg:w-1/2 sm:w-1/4 w-full block mb-5 sm:mb-0'>
              <img class='mx-auto sm:mx-0' src='./image/logo.svg' alt='hackflix' />
            </a>
          ...
          <div class='container mx-auto text-center'>
            <ul class='flex flex-row justify-center categories-list'>
              ...
              <li key={'category-1'} onClick={() => {}}>
                <button class={'px-3 md:px-6 py-3 block'}>Category</button>
              </li>
              {/* End: Category */}
              {/* Start: Category */}
